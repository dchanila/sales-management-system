...
<table class="batles_pro">
  ...
  <tr>
                        ...
                        <td><a href="../site_estimation_add_daily?delete_estimation_daily=<?php echo $row['id']; ?>" class="btns_danger"><span class="memb"><i class="fa fa-trash" aria-hidden="true" ></i></span> Delete</a></td>
...
<form action="../backend/client.php" method="post" class="batles_pro_blocks" id="batles_pro_blocks">
  ...
  <tr> 
                        ...
                        <td><input type="submit" name="add_estmtdaily" value="Add" class="btn_s" ></td>
  </tr>
