...
$totalweeklysitepay="";
$sumallweekly='';
$total_weeklyconssiteservc=array();
$totalweeklysiteservc="";
if($siteview_service_weekly->num_rows > 0){
...
<?php  while($row =$siteview_service_weekly->fetch_assoc()) { ?>
<tr>
<td><?php echo $row['dates']; ?></td>
...
<td><?php echo $row['price_per_each'];?></td>
<td><?php echo $row['total'];array_push($total_weeklyconssiteservc, $row['total']);?></td>
</tr>
<?php } ?>
<tr>
<td><strong>Subtotal</strong></td>
<?php $totalweeklysiteservc=array_sum($total_weeklyconssiteservc);?>
<td style="text-align:center;" colspan="2"><strong><?php echo($totalweeklysiteservc)." Tsh" ?></strong></td>
</tr>
</table>
...
<td colspan="5"><strong><?php $sumallweekly=$totalweeklymaterial+$totalweeklysitefuel+$totalweeklysitepay+$totalweeklyfuel+$totalweeklyservc+$totalweeklypays+$totalproctioncostweekly+$totalweeklysiteservc; echo $sumallweekly."Tsh";?></strong></td>
</tr>
</table>
</div>
</div>
