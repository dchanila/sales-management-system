...
$totaldailsitepay="";
$sumalldaily='';
$total_dailyconssiteservc=array();
$totaldailsiteservc="";
...
<td><?php echo $row['price_per_each'];?></td>
<td><?php echo $row['total']; array_push($total_dailyconssiteservc,$row['total']);?></td>
</tr>
<?php } ?>
<tr>
<td><strong>Subtotal</strong></td>
<?php $totaldailsiteservc=array_sum($total_dailyconssiteservc);?>
<td style="text-align:center;" colspan="2"><strong><?php echo($totaldailsiteservc)." Tsh" ?></strong></td>
</tr>
</table>
...
<td colspan="5"><strong><?php $sumalldaily=$totaldailmaterial+$totaldailsitefuel+$totaldailsitepay+$totaldailfuel+$totaldailservc+$totaldailpays+$totalproctioncost+$totaldailsiteservc; echo $sumalldaily."Tsh";?></strong></td>
</tr>
</table>
</div>
</div>
