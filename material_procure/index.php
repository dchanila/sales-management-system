...
<div class="contents" id="contents">
  <h6 style="padding: 6px;">Materials procurement</h6>
...
<table class="batles_pro">
  ...
  <tr>
    ...
    <td><span><i class="fa fa-plus" aria-hidden="true"></i></span><a href="../material_procure_add?mname=<?php  echo $row['matarial_name']; ?>">Add</a></td>  
    <td><span><i class="fa fa-eye" aria-hidden="true"></i></span><a href="../material_procure_view?mname=<?php  echo $row['matarial_name']; ?>">View</a></td>
  </tr>
  <?php } ?>
</table>
