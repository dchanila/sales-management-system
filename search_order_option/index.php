...
if ($dateFrom=='') {
$view_order_actz = $db->fetch("SELECT * FROM $looking WHERE order_name LIKE '%$product%' or  order_type LIKE '%$product%' or statuz LIKE '%$product%' ORDER by dates DESC");
}elseif ($product=='') {
$view_order_actz = $db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
}else{
$view_order_actz = $db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND order_name LIKE '%$product%' or  order_type LIKE '%$product%' or statuz LIKE '%$product%' ORDER by dates DESC");
}
