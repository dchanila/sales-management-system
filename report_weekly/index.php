...
$totalcash='';
$totalowe='';
if($view_weekly_reportproduction  ->num_rows > 0){

}
if($view_weekly_reportsalesz  ->num_rows > 0){
...
<tr>
<th colspan="7" ><?php echo $product." Weekly"; ?></th>
</tr>
<tr>
...
<?php  while($row = $view_weekly_reportproduction->fetch_assoc()) { ?>
<tr >
<td style="text-align:center;"><?php  echo $row['dates']; $weekss=$row['dates'];
?></td>
...
<td colspan="4">
<table style="width: 100%;">
<?php  while($row = $view_weekly_reportsalesz->fetch_assoc()) { ?>
<tr >
