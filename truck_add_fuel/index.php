...
if($truckview_fuel_daily->num_rows > 0){
...
<table class="batles_pro">
  ...
  <?php  while($row =$truckview_fuel_daily->fetch_assoc()) { ?>
  <tr>
                        ...
                        <td><?php echo $row['total'];?></td>
                         <td><a href="../truck_add_fuel?delete_fuel=<?php echo $row['id']; ?>&&tname=<?php echo $row['truck_name']; ?>" class="btns_danger"><span class="memb"><i class="fa fa-trash" aria-hidden="true" ></i></span> Delete</a></td>
...
<form action="../backend/client.php" method="post" class="batles_pro_blocks" id="batles_pro_blocks">
  ...
  <tr> 
                        ...
                        <td><input type="text" name="liters" placeholder=" liter ? " required></td>
                        <td><input type="text" name="price_per_liter" placeholder="price per liter" required></td>
                        <td><input type="submit" name="add_truckfuel" value="Add" class="btn_s" ></td>
  </tr>
