...
include '../header.php';
if ($dateFrom=='') {
$blocks_productionsearchzs=$db->fetch("SELECT * FROM $looking WHERE product LIKE '%$product%' ORDER by dates DESC");
}elseif ($product=='') {
$blocks_productionsearchzs=$db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
}else{
$blocks_productionsearchzs=$db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND product LIKE '%$product%' ORDER by dates DESC");
}
