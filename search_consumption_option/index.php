...
if ($dateFrom==''){
$siteview_service_monthlyz= $db->fetch("SELECT * FROM service_site WHERE description LIKE '%$product%' OR type_of_service LIKE '%$product%'  ORDER by dates DESC");
$view_product_cost_monthlyconsmpz = $db->fetch("SELECT * FROM production_cost WHERE product LIKE '%$product%' OR type_of_charge LIKE '%$product%'  ORDER by dates DESC");
$view_material_procure_monthlyconsupz = $db->fetch("SELECT * FROM material_procure WHERE material_type LIKE '%$product%'  ORDER by dates DESC");
$truckview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM truck_fuel WHERE truck_name LIKE '%$product%'  ORDER by dates DESC");
$truckview_service_monthlyconsumpz= $db->fetch("SELECT * FROM truck_service WHERE truck_name LIKE '%$product%' OR type_of_service LIKE '%$product%' ORDER by dates DESC");
$truckview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM truck_payment WHERE truck_name LIKE '%$product%' OR pay_for LIKE '%$product%'  ORDER by dates DESC");
$siteview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM fuel_site WHERE description LIKE '%$product%'  ORDER by dates DESC");
$siteview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM site_payment WHERE pay_for LIKE '%$product%'  ORDER by dates DESC");
}elseif ($product=='') {
$siteview_service_monthlyz= $db->fetch("SELECT * FROM service_site WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$view_product_cost_monthlyconsmpz = $db->fetch("SELECT * FROM production_cost WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$view_material_procure_monthlyconsupz = $db->fetch("SELECT * FROM material_procure WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$truckview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM truck_fuel WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$truckview_service_monthlyconsumpz= $db->fetch("SELECT * FROM truck_service WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$truckview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM truck_payment WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$siteview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM fuel_site WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
$siteview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM site_payment WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
}else{
$siteview_service_monthlyz= $db->fetch("SELECT * FROM service_site WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND description LIKE '%$product%' ORDER by dates DESC");
$view_product_cost_monthlyconsmpz = $db->fetch("SELECT * FROM production_cost WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND product LIKE '%$product%' ORDER by dates DESC");
$view_material_procure_monthlyconsupz = $db->fetch("SELECT * FROM material_procure WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND material_type LIKE '%$product%' ORDER by dates DESC");
$truckview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM truck_fuel WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND truck_name LIKE '%$product%' ORDER by dates DESC");
$truckview_service_monthlyconsumpz= $db->fetch("SELECT * FROM truck_service WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND truck_name LIKE '%$product%' ORDER by dates DESC");
$truckview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM truck_payment WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND truck_name LIKE '%$product%' ORDER by dates DESC");
$siteview_fuel_monthlyconsumpz= $db->fetch("SELECT * FROM fuel_site WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND description LIKE '%$product%' ORDER by dates DESC");
$siteview_pay_monthlyconsumpz= $db->fetch("SELECT * FROM site_payment WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND pay_for LIKE '%$product%' ORDER by dates DESC");
}
