...
<table class="batles_pro">
  ...
  <tr>
    ...
    <td><span><i class="fa fa-plus-circle" aria-hidden="true"></i></span><a href="../add_order?product=<?php  echo $row['product_name']; ?>">Add Order</a></td>  
    <td><span><i class="fa fa-eye" aria-hidden="true"></i></span><a href="../order_status?product=<?php  echo $row['product_name']; ?>">view order status</a></td>
  </tr>
  <?php } ?>
</table>
