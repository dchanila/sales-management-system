...
$percee='';
if ($dateFrom=='') {
$product_salesz = $db->fetch("SELECT * FROM $looking WHERE product LIKE '%$product%' ORDER by dates DESC");
}elseif ($product=='') {
$product_salesz = $db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' ORDER by dates DESC");
}else{ 
$product_salesz = $db->fetch("SELECT * FROM $looking WHERE dates BETWEEN '$dateFrom' AND '$dateTo' AND product LIKE '%$product%' ORDER by dates DESC");
}
